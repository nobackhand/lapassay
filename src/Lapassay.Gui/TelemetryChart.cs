...
{
    // INSTRUMENT palette — sourced from InstrumentPalette (mirrors App.axaml tokens).
    ...
    static readonly Pen CpuWPen  = new(new SolidColorBrush(InstrumentPalette.Accent), 2);
    static readonly Pen GpuWPen  = new(new SolidColorBrush(InstrumentPalette.Ok), 2);
